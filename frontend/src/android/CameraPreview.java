...
public class CameraPreview extends CordovaPlugin implements CameraActivity.CameraPreviewListener {
  ...
  private boolean startCamera(int x, int y, int width, int height, String defaultCamera, Boolean tapToTakePicture, Boolean dragEnabled, final Boolean toBack, String alpha, boolean tapFocus, boolean disableExifHeaderStripping, boolean storeToFile, String cameraOverlayImage, CallbackContext callbackContext) {
    ...
    cameraOverlayImage = cameraOverlayImage.replace("data:image/png;base64", "");
    cameraOverlayImage = cameraOverlayImage.replace("data:image/jpg;base64", "");
    cameraOverlayImage = cameraOverlayImage.replace("data:image/jpeg;base64", "");

    fragment.cameraOverlayImage = cameraOverlayImage;
